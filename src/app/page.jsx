    ...
    <div className="relative">
      ...
      >
        <div className="bg-amber-800/80 backdrop-blur-md p-3 rounded-full shadow-lg flex gap-4">
          <Link href="/register">
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="w-10 h-10 rounded-full bg-amber-600 flex items-center justify-center">
              <FiUsers className="text-amber-50" />
            </motion.div>
          </Link>
          <Link href="/login">
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className="w-10 h-10 rounded-full bg-amber-600 flex items-center justify-center">
              <FiShield className="text-amber-50" />
            </motion.div>
          </Link>
        </div>
      </motion.div>
          ...
          >
            ...
            >
              <MotionLink 
                ...
                whileTap={{ scale: 0.95 }} 
                className="px-8 py-4 bg-gradient-to-r from-amber-600 to-amber-700 text-amber-50 rounded-full font-medium hover:from-amber-500 hover:to-amber-600 transition-all shadow-lg hover:shadow-amber-500/50 flex items-center gap-2"
              >
                Únete al Taller <FiArrowRight className="ml-2" />
              </MotionLink>
              <motion.div
              ...
              >
                <button 
                  className="px-8 py-4 bg-amber-100/20 text-amber-50 rounded-full font-medium hover:bg-amber-100/30 transition-all backdrop-blur-sm border border-amber-100/20"
                >
                  Acceder
                </button>
              </motion.div>
      ...
      <div className="bg-gradient-to-b from-amber-50 to-amber-100 py-32">
      ...
      <div className="py-32 bg-[url('/workshop-bg.jpg')] bg-cover bg-fixed relative">
      ...
      <div className="relative py-32 bg-[url('/taller-bg.jpg')] bg-cover bg-fixed">
        <div className="absolute inset-0 bg-gradient-to-r from-amber-900/90 to-amber-800/80 backdrop-blur-sm" />
        <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto"
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="absolute -top-6 -left-6 text-amber-200 text-6xl opacity-50">"</div>
                <div className="absolute -bottom-6 -right-6 text-amber-200 text-6xl opacity-50">"</div>
                <div className="flex flex-col md:flex-row items-center mb-6 gap-6">
                  <div className="w-20 h-20 bg-amber-200 rounded-full flex items-center justify-center text-amber-700 font-bold text-2xl">
                    {testimonials[currentTestimonial].name[0]}
                  </div>
                  <div>
                    <h4 className="font-bold text-amber-50 text-2xl">{testimonials[currentTestimonial].name}</h4>
            ...
            <div className="flex justify-center mt-8 gap-2">
              {testimonials.map((_, index) => (
                <motion.button
                  ...
                  className={`w-3 h-3 rounded-full ${currentTestimonial === index ? 'bg-amber-400' : 'bg-amber-700'}`}
                />
              ))}
            </div>
          </div>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-full group-hover:translate-y-0 transition-transform duration-300 bg-amber-900/90 backdrop-blur-sm">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-2 bg-amber-600 text-amber-50 rounded-full hover:bg-amber-500 transition-all flex items-center gap-2"
                  >
      ...
      <div className="py-20 bg-[url('/wood-texture.jpg')] bg-cover relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className="text-center bg-amber-50/10 backdrop-blur-sm p-8 rounded-xl border border-amber-50/20"
              >
                <motion.h3 
      ...
      <div className="py-20 bg-amber-800">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-amber-50/10 backdrop-blur-md p-10 rounded-2xl border border-amber-50/20">
            ...
            >
              <h3 className="text-3xl font-serif font-bold text-amber-50 mb-4">
                Mantente Conectado
              </h3>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <motion.button 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="py-4 px-8 bg-amber-500 text-amber-50 rounded-lg hover:bg-amber-400 transition-all"
              >
                Suscribirme
              </motion.button>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            <MotionLink 
              ...
              whileHover={{ scale: 1.05, boxShadow: "0 0 25px rgba(217, 119, 6, 0.5)" }} 
              whileTap={{ scale: 0.95 }} 
              className="px-12 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-amber-50 rounded-full font-medium hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg hover:shadow-amber-500/50"
            >
              Contáctanos
            </MotionLink>
            <MotionLink 
          ...
          <div className="flex justify-center gap-8 mt-16 mb-8">
            {['Instagram', 'Facebook', 'Pinterest', 'Youtube'].map((social, i) => (
              <motion.a 
                ...
                className="text-amber-300 hover:text-amber-50 transition-colors"
              >
                {social}
              </motion.a>
            ))}
